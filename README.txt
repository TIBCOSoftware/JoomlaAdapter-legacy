...
/joomlaUpdate - Contains two Joomla update distributions for migration
...
- Adapter Code for TIBCO API Exchange and Joomla! Administration --  Describes
  ...
  users, user groups, and core configuraton.  Also describes how to use the
...
TIBCO package:
    ...
    * Copyright (c) 2011 - 2014  Wordnik, Inc. (licensed under the Apache
      License, version 2.0)
