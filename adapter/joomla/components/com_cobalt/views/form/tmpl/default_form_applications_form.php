...
<div class="form-horizontal asg-create-app-form">
  ...
  <div class="asg-app-step-2 tab-content">
    ...
    <div class="control-group">
      <div class="controls">
        <a class="btn btn-primary asg-create-app-back">Back</a>
        <a class="btn btn-primary asg-create-app-next">Next</a>
      </div>
    </div>
  </div>
  ...
  <!-- Step3 goes here -->
      <div class="row-fluid">
        <div class="span12">
          <?php $apis = $this->sorted_fields[0][64]; ?>
          ...
          <?php $access_level = DeveloperPortalApi::getUserAccessGroupId();?>
          <?php if($access_level):?>
          <input id="jform_access" name="jform[access]" type="hidden" value="<?php echo $access_level;?>" />
          <?php endif;?>
...
<script>
  ...
  jQuery('document').ready(function() {
    ...
    if (step == "#2") {
      jQuery('.asg-app-step-2').show();
      jQuery('.asg-create-app-guide li:first-child').next().addClass('active');
      jQuery('.form-actions .btn').show();
    } else {
      jQuery('.asg-app-step-1').show();
      jQuery('.asg-create-app-guide li:first-child').addClass('active');
    }
  });
</script>
