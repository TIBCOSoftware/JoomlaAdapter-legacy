...
SwaggerResource.prototype.addApiDeclaration = function(response) {
  ...
  // Patch to read resourcepath from the apiresource json file instead of the initial spec file if the resourcepaths in 2 files are different
...
SwaggerOperation.prototype.urlify = function(args) {
  var basePath = jQuery('#select_environment').length > 0 ? jQuery('#select_environment').val() : this.resource.basePath;
  var url = basePath + this.pathJson();
...
JQueryHttpClient.prototype.execute = function(obj) {
  ...
  obj.timeout = 1000 * 60 * 3; // 3 minutes
