...
(function() {
    var ApiKeyAuthorization, SwaggerApi, SwaggerAuthorizations, SwaggerHttp, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource, __bind = function(fn, me) {
        return function() {
    ...
    SwaggerApi = (function() {
        ...
        SwaggerApi.prototype.selfReflect = function() {
            ...
            for (resource_name in _ref) {
                if (_ref.hasOwnProperty(resource)) {
    ...
    SwaggerResource = (function() {
        ...
        function SwaggerResource(resourceObj, api) {
            var consumes, e, obj, parts, produces, _this = this;
            this.api = api;
            this.api = this.api;
            produces = [];
            consumes = [];
   ...
   //this patch is to support ASG-5032 solution
        ...
        SwaggerResource.prototype.help = function() {
            ...
            for (operation_name in _ref) {
                if (_ref.hasOwnProperty(operation_name)) {
    ...
    SwaggerOperation = (function() {
        ...
        function SwaggerOperation(nickname, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces) {
            var parameter, v, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _this = this;
        ...
        SwaggerOperation.prototype.getSampleJSON = function(type, models) {
            ...
            isPrimitive = ((listType != null) && models[listType]) || (models[type] != null) ? false : true;
            val = isPrimitive ?
            void 0 : (listType != null ? models[listType].createJSONSample() : models[type].createJSONSample());
            if (val) {
        ...
        SwaggerOperation.prototype["do"] = function(args, opts, callback, error) {
            ...
            if (possibleParams) {
                for (key in possibleParams) {
                    if (possibleParams.hasOwnProperty(key)) {
        ...
        SwaggerOperation.prototype.urlify = function(args) {
            ...
            url = ((jQuery('#select_environment') && jQuery('#select_environment').val()) ? jQuery('#select_environment').val() : this.resource.basePath) + this.pathJson();
            _ref = this.parameters;
            for ( _i = 0, _len = _ref.length; _i < _len; _i++) {
                param = _ref[_i];
    ...
    SwaggerRequest = (function() {
        ...
        function SwaggerRequest(type, url, params, opts, successCallback, errorCallback, operation, execution) {
            var body, e, fields, headers, key, myHeaders, name, obj, param, parent, possibleParams, requestContentType, responseContentType, urlEncoded, value, values, _this = this;
            this.type = type;
            this.url = url;
            this.params = params;
            this.opts = opts;
    ...
    SwaggerHttp = (function() {
        ...
        function SwaggerHttp() {
            var identity, toString, _this = this;
            if ( typeof window !== 'undefined') {
