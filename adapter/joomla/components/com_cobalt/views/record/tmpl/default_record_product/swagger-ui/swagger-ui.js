...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    /**
     * Get the size of a given string in bytes. UTF8 encoding is presumed.
     *
     * @param {String} sContent The string of which the size in bytes is going to be calculated.
     * @returns {Number} The size of the given string in bytes.
     */
    OperationView.prototype.stringLenInUtf8Bytes = function(sContent) {
        var nSize = 0, i = 0;
        if(sContent) {
            nSize = sContent.length;
            for (i = sContent.length - 1; i >= 0; i--) {
                var code = sContent.charCodeAt(i);
    ...
    OperationView.prototype.showStatus = function(response) {
      ...
      jQuery(".request_headers", jQuery(this.el)).html("<pre>" + _.escape(JSON.stringify(response.request.headers, null, "  ")).replace(/\n/g, "<br />") + "</pre>");
      ...
      if (opts.highlightSizeThreshold && this.stringLenInUtf8Bytes(response.data) > opts.highlightSizeThreshold) {
