...
require_once JPATH_LIBRARIES . "/tibco/tibco/tibco.php";
?>
<ul class="unstyled">
	<?php foreach ($this->files AS $file):?>
		<li>
            ...
            <br />
            <a href="<?php echo JUri::base() ?>index.php?option=com_cobalt&task=ajaxmore.getFacadeWSDL&file_id=<?php echo $file->id; ?>" target="_blank"><?php echo Tibcotibco::insertFacadeInFileName($file->realname); ?></a>
			<?php if($this->hits):?>
