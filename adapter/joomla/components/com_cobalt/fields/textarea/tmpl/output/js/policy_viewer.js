...
(function ($) {
    ...
    var jqMask = $('<div id="policy_viewer_mask" class="policy-viewer-position"></div>'),
        ...
        oConstants = {
            ...
            DIRTY_STATUS_SPAN_ID: 'policy_dirty_status',
     ...
     * @returns {Object} An object containing the information of policy types.
     */
     ...
     *
     * @author Kevin Li<huali@tibco-support.com>
     * @param {string} sWizardName The name of the wizard to be returned.
     * @param {Function} fDone A callback function for the successful response.
     * @returns {Object|undefined} An object containing the data about the wizard of a specific type of policy if the
     * fDone argument is omitted. Or an undefined value if the fDone argument is provided.
     */
    function loadWizard(sWizardName, fDone) {

        var jqXHR = getTemplate(sWizardName).fail(function (jqXHR, textStatus) {
