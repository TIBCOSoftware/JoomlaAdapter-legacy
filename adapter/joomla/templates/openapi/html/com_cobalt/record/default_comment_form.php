...
<div style="width:700px;" class="modal hide fade" id="commentmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="commentlabel"><?php echo JText::_('CEDITCOMMENT');?></h3>
	</div>

	<div id="commentframe" class="modal-body" style="overflow-x: hidden; max-height:500px; padding:0;">
...
<div class="form-horizontal">
	...
	<?php
	    echo $this->comment_form->getInput('comment');
	?>
