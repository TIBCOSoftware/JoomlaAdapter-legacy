...
?>
<br />
<form action="<?php echo JRoute::_('index.php?option=com_cobalt&view=users&layout=modal&tmpl=component&groups='.JFactory::getApplication()->input->getBase64('groups').'&excluded='.JFactory::getApplication()->input->get('excluded', '', 'default', 'BASE64'));?>" method="post" name="adminForm" id="adminForm">
	<div class="controls">
	...
	<table class="table table-hover">
		...
		<tbody>
		<?php
                        if ( in_array( '8', $onlineUser->groups) ) {
