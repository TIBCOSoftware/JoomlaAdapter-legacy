...
<form action="<?php echo JRoute::_('index.php?option=com_config');?>" id="application-form" method="post" name="adminForm" class="form-validate">
   ...
   <?php 
    ...
    if ( JComponentHelper::isEnabled( 'com_emails', true) ) {
   
   $comEmail = JComponentHelper::getComponent('com_emails');
	$showPermissions =$comEmail->params->get('showPermissions');
	$showTextFilters = $comEmail->params->get('showTextFilters');
	$showPermissions= isset($showPermissions) ? $showPermissions:true; 
	$showTextFilters =isset($showTextFilters) ? $showTextFilters:true;
    }else{
    	$showPermissions=true;
    	$showTextFilters=true;
	...
	?>
				...
				<?php   
			echo JHtml::_('bootstrap.addTab', 'myTab', 'page-permissions', JText::_('COM_CONFIG_PERMISSIONS', true)); ?>
					<div class="row-fluid">
						<?php echo $this->loadTemplate('permissions'); ?>
					</div>
				<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php endif; ?>
			<?php if ($showTextFilters) : ?>
